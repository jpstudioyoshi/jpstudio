...
// ═══════════════════════════════════════════════════════════════════════════════
// ═══════════════════════════════════════════════════════════════════════════════
// Yoshi sessions — merged from features-yoshi.js
// ═══════════════════════════════════════════════════════════════════════════════
// ═══════════════════════════════════════════════════════
// YOSHI SESSIONS
// ═══════════════════════════════════════════════════════
  ...
  overlay.innerHTML = `
    <div class="yoshi-popup">
      ...
      <div class="yoshi-popup-foot">
        <button class="yoshi-import-btn btn-action" onclick="yoshiVocabPopupAddRow()">＋ Add row</button>
...
Object.assign(App, {
  ...
  yoshiGetSessions, yoshiSaveSessions, yoshiRender,
});
